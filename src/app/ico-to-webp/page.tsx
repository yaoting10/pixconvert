...
function DetailedContent() {
  return (
    <section className="py-16 px-6 mx-auto max-w-[1120px] border-t border-outline-variant">
      <h2 className="font-[family-name:var(--font-space-grotesk)] text-2xl sm:text-3xl font-semibold text-on-background mb-8 text-center">
        Understanding ICO to WEBP Conversion
      </h2>
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-base text-on-surface-variant leading-relaxed mb-4">Converting ICO to WEBP is a common need for photographers, designers, web developers, and anyone working with digital images. WebP delivers smaller file sizes than both JPG and PNG while maintaining excellent quality. It's the preferred format for modern websites and applications focused on performance.</p>
        <p className="text-base text-on-surface-variant leading-relaxed mb-4">PixConvert makes ICO to WEBP conversion incredibly simple. Our browser-based tool processes your files locally using WebAssembly technology, which means your images never leave your device. There's no need to upload sensitive photos to external servers or wait in processing queues.</p>
